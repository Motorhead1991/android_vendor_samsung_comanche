...
PRODUCT_COPY_FILES += \
	vendor/samsung/comanche/proprietary/lib/libacdbloader.so:obj/lib/libacdbloader.so \
	vendor/samsung/comanche/proprietary/lib/libaudioalsa.so:obj/lib/libaudioalsa.so

PRODUCT_COPY_FILES += \
    vendor/samsung/comanche/proprietary/lib/libbluedroid.so:system/lib/libbluedroid.so \
    ...
    vendor/samsung/comanche/proprietary/lib/modules/prima/prima_wlan.ko:system/lib/modules/prima/prima_wlan.ko \
    ...
    vendor/samsung/comanche/proprietary/bin/port-bridge:system/bin/port-bridge \
    vendor/samsung/comanche/proprietary/bin/usbhub:system/bin/usbhub \
    vendor/samsung/comanche/proprietary/bin/usbhub_init:system/bin/usbhub_init \
    ...
    vendor/samsung/comanche/proprietary/etc/thermald.conf_F:system/etc/thermald.conf_F \
    vendor/samsung/comanche/proprietary/etc/thermald.conf_N:system/etc/thermald.conf_N \
    vendor/samsung/comanche/proprietary/etc/thermald.conf_S:system/etc/thermald.conf_S \
    ...
    vendor/samsung/comanche/proprietary/lib/libalsa-intf.so:system/lib/libalsa-intf.so \
    ...
    vendor/samsung/comanche/proprietary/lib/libsamsungRecord.so:system/lib/libsamsungRecord.so \
    vendor/samsung/comanche/proprietary/lib/libaudiopolicy_sec.so:system/lib/libaudiopolicy_sec.so \
    vendor/samsung/comanche/proprietary/lib/lib_Samsung_Resampler.so:system/lib/lib_Samsung_Resampler.so \
    vendor/samsung/comanche/proprietary/lib/lib_SamsungRec_V01005.so:system/lib/lib_SamsungRec_V01005.so \
    vendor/samsung/comanche/proprietary/lib/libcontrolcsc.so:system/lib/libcontrolcsc.so \
    ...
    vendor/samsung/comanche/proprietary/lib/libsc-a3xx.so:system/lib/libsc-a3xx.so \
    ...
    vendor/samsung/comanche/proprietary/bin/wdsdaemon:system/bin/wdsdaemon \
    ...
    vendor/samsung/comanche/proprietary/bin/wiperiface_v02:system/bin/wiperiface_v02 \
    vendor/samsung/comanche/proprietary/bin/quipc_igsn:system/bin/quipc_igsn \
    vendor/samsung/comanche/proprietary/bin/quipc_main:system/bin/quipc_main \
    vendor/samsung/comanche/proprietary/lib/hw/gps.default.so:system/lib/hw/gps.default.so \
    vendor/samsung/comanche/proprietary/lib/libloc_eng.so:system/lib/libloc_eng.so \
    vendor/samsung/comanche/proprietary/lib/libloc_adapter.so:system/lib/libloc_adapter.so \
    vendor/samsung/comanche/proprietary/lib/libgps.utils.so:system/lib/libgps.utils.so \
    vendor/samsung/comanche/proprietary/lib/libloc_api_v02.so:system/lib/libloc_api_v02.so \
    vendor/samsung/comanche/proprietary/lib/libcurl.so:system/lib/libcurl.so \
    vendor/samsung/comanche/proprietary/lib/libbson.so:system/lib/libbson.so \
    vendor/samsung/comanche/proprietary/lib/libquipc_os_api.so:system/lib/libquipc_os_api.so \
    vendor/samsung/comanche/proprietary/lib/libquipc_ulp_adapter.so:system/lib/libquipc_ulp_adapter.so \
    vendor/samsung/comanche/proprietary/lib/libwifiscanner.so:system/lib/libwifiscanner.so \
    vendor/samsung/comanche/proprietary/vendor/firmware/libpn544_fw.so:system/vendor/firmware/libpn544_fw.so \
    vendor/samsung/comanche/proprietary/bin/geomagneticd:system/bin/geomagneticd \
    vendor/samsung/comanche/proprietary/bin/orientationd:system/bin/orientationd \
    vendor/samsung/comanche/proprietary/lib/hw/sensors.msm8960.so:system/lib/hw/sensors.msm8960.so \
    vendor/samsung/comanche/proprietary/lib/libAKM.so:system/lib/libAKM.so \
    ...
    vendor/samsung/comanche/proprietary/etc/firmware/cyttsp_8960_cdp.hex:system/etc/firmware/cyttsp_8960_cdp.hex \
